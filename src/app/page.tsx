...
// import { motion } from 'framer-motion';
import { FaRocket, FaStore, FaComments, FaChartLine, FaGift, FaUsers, FaChartBar, FaMapMarkedAlt, FaBrain } from 'react-icons/fa';
import styles from './page.module.css';
import dynamic from 'next/dynamic';
// import heroImage from '../app/assets/header.jpg';

const HeroVideo = dynamic(() => import('./components/Heeader/Hero'), { ssr: false });
    ...
    <main>
      ...
      <section className={styles.sectionGray}>
        ...
        <div className={styles.card}><FaStore /> <h3>Rede Social</h3><p>Interação, descoberta e recompensas para consumidores.</p></div>
          ...
          <div className={styles.card}><FaComments /> <h3>Chat</h3><p>Chat interligando as três aplicações.</p></div>
          <div className={styles.card}><FaBrain /> <h3>I.A</h3><p>Inteligência Artificial para melhoria dos negócios.</p></div>
        </div>
      </section>
      {/* 4. Diferenciais */}
